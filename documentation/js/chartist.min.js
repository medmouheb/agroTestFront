        ...
        (d =
          ...
          b.raw.series.forEach(
            function (f, g) {
              var i = h.elem("g");
              i.attr(
                { "series-name": f.name, meta: c.serialize(f.meta) },
                c.xmlNs.uri,
              ),
                i.addClass(
                  [
          ...
          d.raw.series.forEach(
            function (b, e) {
              ...
              (f =
                ...
                (h = g.elem("g")),
                h.attr(
                  { "series-name": b.name, meta: c.serialize(b.meta) },
                  c.xmlNs.uri,
                ),
                h.addClass(
                  [
