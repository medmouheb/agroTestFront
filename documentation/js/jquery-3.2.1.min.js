...
!(function (a, b) {
  ...
  var ja = /^(?:checkbox|radio)$/i,
    ...
    ma = {
      ...
      thead: [1, "<table aria-label="">", "</table>"],
      col: [2, "<table aria-label=""><colgroup>", "</colgroup></table>"],
      tr: [2, "<table aria-label=""><tbody>", "</tbody></table>"],
      td: [3, "<table aria-label=""><tbody><tr>", "</tr></tbody></table>"],
      _default: [0, "", ""],
    };
