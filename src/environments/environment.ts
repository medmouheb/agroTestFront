...
//  urlBack: "http://localhost:8081/agrotech-api",
 // auth: "http://localhost:8080/api/auth",
  ...
  titleChartPrixOilOlive: "Prix (prix courant)",
  titleChartRepartition: "Répartition des superficies par gouvernorat",
  titleChartClassement: "Classement des gouvernorarts selon la production (T)",

  titleCard1: "Superficie moyenne de production",
  titleCard2: "Production moyenne en Tonne",
  titleCard3: "Prix Moyen à l'exportation",
  titleCard4: "Quantité moyenne exportée en Tonne",
};
