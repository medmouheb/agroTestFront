...
export class manufacturerService {
  ...
  getActiveManufacturers(): Observable<manufacturer[]> {
    ...
    return this.http.get<manufacturer[]>(
      this.baseUrl() + "/manufacturer/active",
      { headers },
    );
  }
  getArchivedManufacturers(): Observable<manufacturer[]> {
    ...
    return this.http.get<manufacturer[]>(
      this.baseUrl() + "/manufacturer/archived",
      { headers },
    );
  }
  ...
  searchManufacturerByNameActive(
    ...
    return this.http.get<manufacturer[]>(
      this.baseUrl() + "/manufacturer/searchactive",
      { params, ...{ headers } },
    );
  }
  searchManufacturerByNameArchived(
    manufacturerName: string,
  ): Observable<manufacturer[]> {
    const headers = new HttpHeaders().set(
      "Authorization",
    ...
    const params = { manufacturerName: manufacturerName };
    return this.http.get<manufacturer[]>(
      this.baseUrl() + "/manufacturer/searcharchived",
      { params, ...{ headers } },
    );
  }
