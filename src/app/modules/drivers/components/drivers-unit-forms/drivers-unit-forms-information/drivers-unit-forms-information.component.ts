...
export class DriversUnitFormsInformationComponent implements OnInit {
  ...
  initForm() {
    this.addform = new FormGroup({
      ...
      nombreMaximumHeureTravailles: new FormControl(
        this.camp.nombreMaximumHeureTravailles,
      ),
      DriverLicenceExpiration: new FormControl(
        this.camp.DriverLicenceExpiration,
      ),
