...
export class VendorSKUFormGeneralComponent implements OnInit {
  ...
  initForm() {
    ...
    this.addform = new FormGroup({
      ...
      vendorSKUCode: new FormControl(null, [Validators.required]),
    });
  }
  ...
  geValues(event) {
    console.log("this.currency.code.length");
    console.log(
  ...
  isBlur() {
    if (this.Vendorsku.vendorCode == undefined) {
      ...
      this.Vendorsku.vendorCode.toString().length == 0 &&
      this.Vendorsku.vendorCode == ""
    ) {
      this.minIstrueCode = true;
    } else {
  ...
  isBlurDCisvalid() {
    if (this.Vendorsku.vendorSKUCode == undefined) {
      ...
      this.Vendorsku.vendorSKUCode.toString().length < 1 ||
      this.Vendorsku.vendorSKUCode == undefined
    ) {
      this.DCisvalid = true;
    } else {
  ...
  isBlurDNisvalid() {
    if (this.Vendorsku.vendorSKUName == undefined) {
      ...
      this.Vendorsku.vendorSKUName.toString().length < 1 ||
      this.Vendorsku.vendorSKUName == undefined
    ) {
      this.DNisvalid = true;
    } else {
  ...
  isBlur5() {
    if (
      this.Vendorsku.vendorCode == "" ||
      this.Vendorsku.vendorCode == undefined
    ) {
      this.dvendor = true;
    } else {
      this.dvendor = false;
