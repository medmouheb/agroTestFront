...
export class WillayaFormGeneralComponent implements OnInit {
  ...
  constructor(
    ...
    private willayaser: WillayaService,
  ...
  getetat() {
    if (
      ...
      this.willaya.code == undefined ||
      this.willaya.name == undefined
    ) {
  ...
  isBlurDCisvalid() {
    if (this.willaya.code == undefined) {
      this.DCisvalid = true;
    } else if (this.willaya.code.toString().length < 1) {
      this.DCisvalid = true;
    } else {
  ...
  isBlurDNisvalid() {
    ...
    if (this.willaya.name.toString().length < 1) {
      this.DNisvalid = true;
    } else {
