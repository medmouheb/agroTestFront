...
export class seaportService {
  ...
  getActiveSeaports(): Observable<seaport[]> {
    ...
    return this.http.get<seaport[]>(this.baseUrl() + '/seaport/active' , {headers});
  }
  getArchivedSeaports(): Observable<seaport[]> {
    ...
    return this.http.get<seaport[]>(this.baseUrl() + '/seaport/archived' , {headers});
  }
  ...
  searchSeaportByNameActive(seaPortName: string): Observable<seaport[]> {
    ...
    return this.http.get<seaport[]>(this.baseUrl() + "/seaport/searchactive", { params  , ...{headers}});
  }
  searchSeaportByNameArchived(seaPortName: string): Observable<seaport[]> {
    ...
    const params = { seaPortName: seaPortName };
    return this.http.get<seaport[]>(this.baseUrl() + "/seaport/searcharchived", { params ,... {headers} });
  }
