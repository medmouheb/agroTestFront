...
export class reasonService {
    ...
    getActiveReasons(): Observable<reason[]> {
        ...
        return this.http.get<reason[]>(this.baseUrl() + '/reason/active' , {headers});
    }
    getArchivedReasons(): Observable<reason[]> {
        ...
        return this.http.get<reason[]>(this.baseUrl() + '/reason/archived' , {headers});
    }
    ...
    searchReasonByNameActive(reasonName: string): Observable<reason[]> {
        ...
        return this.http.get<reason[]>(this.baseUrl() + "/reason/searchactive", { params ,... {headers} });
    }
    searchReasonByNameArchived(reasonName: string): Observable<reason[]> {
        ...
        const params = { reasonName: reasonName };
        return this.http.get<reason[]>(this.baseUrl() + "/reason/searcharchived", { params ,... {headers} });
    }
