...
export class WarehouseFormGeneralComponent implements OnInit {
  ...
  selectVAlue(e: any) {
    let t = this.costcenters.filter((el) => {
  ...
  selectVAlue2(e: any) {
    let t = this.fournisseurs.filter((el) => {
      return el.code == e.target.value;
    })[0];
  ...
  isBlur4() {
    if (
      this.myForm.value.costCenterCode == "" ||
      this.warehouse.costCenterCode == undefined
    ) {
      this.divisinv = true;
    } else {
      this.divisinv = false;
  ...
  isPrimaryValid() {
    if (
      this.addForm.value.isPrimary == "false" ||
      this.addForm.value.isPrimary == "true"
    ) {
  ...
  isBlurDNisvalid() {
    if (this.warehouse.name == undefined) {
      this.DNisvalid = true;
    } else if (this.warehouse.name.toString().length < 1) {
      this.DNisvalid = true;
    } else {
  ...
  isBlurCCCisvalid() {
    ...
    if (this.warehouse.costCenterCode.toString().length < 5) {
      this.CCCisvalid = true;
    } else {
  ...
  isBlurCCNisvalid() {
    ...
    if (this.warehouse.costCenterName.toString().length < 3) {
      this.CCNisvalid = true;
    } else {
  ...
  isMaiLisvalid() {
    ...
    if (
      this.warehouse.email.toString().length < 3 ||
      !this.warehouse.email.toString().includes("@") ||
      !this.warehouse.email.toString().includes(".")
    ) {
  ...
  isprimarytype() {
    return (
      ...
      this.DNisvalid2 &&
      this.DCisvalid2 &&
      this.addForm.value.type == undefined
    );
  }
}
